	...
	createDb() {
		const pages = [
			...
			},
			{
				...
				title:
					'This is free landing page template you can use for your projects. It is free to use for your personal and commercial projects, enjoy!',
